...
internal enum Asset {
  internal enum Images {
    ...
    internal static let addPurper = ImageAsset(name: "add-purper")
    internal static let attachFile24px = ImageAsset(name: "attach_file-24px")
    internal static let back = ImageAsset(name: "back")
    internal static let call24px = ImageAsset(name: "call-24px")
    internal static let call24px1 = ImageAsset(name: "call-24px1")
    internal static let change = ImageAsset(name: "change")
    internal static let chat24px = ImageAsset(name: "chat-24px")
    internal static let closeCircle = ImageAsset(name: "close-circle")
    internal static let communityFill = ImageAsset(name: "community-fill")
    internal static let communityLine = ImageAsset(name: "community-line")
    internal static let compass = ImageAsset(name: "compass")
    internal static let contact16px = ImageAsset(name: "contact-16px")
    internal static let contactFill = ImageAsset(name: "contact_fill")
    internal static let contactLine = ImageAsset(name: "contact_line")
    internal static let description24px = ImageAsset(name: "description-24px")
    internal static let down = ImageAsset(name: "down")
    internal static let edit = ImageAsset(name: "edit")
    internal static let exitToAppBlack24dp = ImageAsset(name: "exit_to_app_black_24dp")
    internal static let expansionFill = ImageAsset(name: "expansion-fill")
    internal static let expansionLine = ImageAsset(name: "expansion-line")
    internal static let formatIndentDecrease24px = ImageAsset(name: "format_indent_decrease-24px")
    internal static let group24px2 = ImageAsset(name: "group-24px (2)")
    internal static let history = ImageAsset(name: "history")
    internal static let home5Fill = ImageAsset(name: "home-5-fill")
    internal static let homeLine = ImageAsset(name: "home-line")
    internal static let icAddBlack24px = ImageAsset(name: "ic_add_black_24px")
    internal static let info16px = ImageAsset(name: "info-16px")
    internal static let info24px = ImageAsset(name: "info-24px")
    internal static let launchScreenLogo = ImageAsset(name: "launch_screen_logo")
    internal static let lock = ImageAsset(name: "lock")
    internal static let logoutBoxRLine = ImageAsset(name: "logout-box-r-line")
    internal static let message24px = ImageAsset(name: "message-24px")
    internal static let more = ImageAsset(name: "more")
    internal static let nodefyLogo = ImageAsset(name: "nodefy-logo")
    internal static let notifications24px1 = ImageAsset(name: "notifications-24px (1)")
    internal static let `open` = ImageAsset(name: "open")
    internal static let outlineSupervisorAccount24px = ImageAsset(name: "outline-supervisor_account-24px")
    internal static let people24px = ImageAsset(name: "people-24px")
    internal static let personAddAlt124px = ImageAsset(name: "person_add_alt_1-24px")
    internal static let phoneFill = ImageAsset(name: "phone-fill")
    internal static let phoneLine = ImageAsset(name: "phone-line")
    internal static let plusCircle = ImageAsset(name: "plus-circle")
    internal static let `public` = ImageAsset(name: "public")
    internal static let pushPin24px = ImageAsset(name: "push_pin-24px")
    internal static let questionLine = ImageAsset(name: "question-line")
    internal static let searchLine = ImageAsset(name: "search-line")
    internal static let search = ImageAsset(name: "search")
    internal static let sentimentSatisfiedAlt24px = ImageAsset(name: "sentiment_satisfied_alt-24px")
    internal static let setting = ImageAsset(name: "setting")
    internal static let settings4Line = ImageAsset(name: "settings-4-line")
    internal static let share24px = ImageAsset(name: "share-24px")
  }
