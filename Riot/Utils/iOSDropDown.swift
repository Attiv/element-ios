...
open class DropDown : UITextField{
    ...
    @objc public var optionArray = [String]() {
        didSet{
            self.dataArray = self.optionArray
        }
    }
    @objc public var optionImageArray = [String]() {
        didSet{
            self.imageArray = self.optionImageArray
        }
    }
    @objc public var optionIds : [Int]?
    ...
    @objc   public func didSelect(completion: @escaping (_ selectedText: String, _ index: Int , _ id:Int ) -> ()) {
        didSelectCompletion = completion
    }

    @objc  public func listWillAppear(completion: @escaping () -> ()) {
        TableWillAppearCompletion = completion
    }

    @objc  public func listDidAppear(completion: @escaping () -> ()) {
        TableDidAppearCompletion = completion
    }

    @objc  public func listWillDisappear(completion: @escaping () -> ()) {
        TableWillDisappearCompletion = completion
    }

    @objc  public func listDidDisappear(completion: @escaping () -> ()) {
